...
<div class="container section" style="text-align: center; max-width: 600px;">
    ...
    <p style="color: var(--text-secondary); font-size: 18px; margin-bottom: 40px;">Your order #{{ str_pad($order->id, 8, '0', STR_PAD_LEFT) }} has been placed and is being processed.</p>

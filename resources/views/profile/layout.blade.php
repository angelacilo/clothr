...
@section('extra_css')
        .profile-layout { display: grid; grid-template-columns: 280px 1fr; gap: 60px; }
        .profile-sidebar { background: transparent; border-right: 1px solid var(--border-color); padding-right: 40px; }
        ...
        .profile-nav-link:hover { background: rgba(0,0,0,0.03); color: #000; }
        ...
        .profile-content { background: transparent; }
        ...
        .order-card { border: 1px solid var(--border-color); border-radius: 12px; margin-bottom: 25px; overflow: hidden; background: #fff; }
        .order-card-header { background: var(--sand); padding: 15px 20px; display: flex; justify-content: space-between; align-items: center; font-size: 13px; border-bottom: 1px solid var(--border-color); }
        .order-card-body { padding: 20px; }
        .order-item { display: flex; gap: 18px; margin-bottom: 18px; }
        .order-item img { width: 80px; height: 80px; object-fit: cover; border-radius: 10px; }
